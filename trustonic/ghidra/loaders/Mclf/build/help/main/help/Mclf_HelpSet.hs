...
<!-- HelpSet auto-generated on Sun Sep 29 14:32:44 CEST 2019 -->
<helpset version="2.0">
	<title>Mclf HelpSet</title>
	<maps>
		<mapref location="Mclf_map.xml" />
	</maps>
	<view mergetype="javax.help.UniteAppendMerge">
		<name>TOC</name>
		<label>Ghidra Table of Contents</label>
		<type>docking.help.CustomTOCView</type>
		<data>Mclf_TOC.xml</data>
	</view>
	<view>
		<name>Search</name>
		<label>Search for Keywords</label>
		<type>docking.help.CustomSearchView</type>
		<data engine="com.sun.java.help.search.DefaultSearchEngine">Mclf_JavaHelpSearch</data>
	</view>
	<view>
		<name>Favorites</name>
